	...
	<div id="container">
		...
		<div id="sub" class="bbs">
			<h2 id="container_title">
				성공스토리<span class="sound_only"> 목록</span>
			</h2>
			...
			<div id="bo_list" style="width: 100%">
				...
				<form name="fboardlist" id="fboardlist"
					...
					<input type="hidden" name="bo_table" value="story"> <input
					...
					<div class="tbl_head01 tbl_wrap">
						<table>
							<caption>성공스토리 목록</caption>
							<tbody class="bo_tr">
								<tr>
									<td>
										<div class="img_area">
											<a
												href="https://ebiga.co.kr/home/bbs/board.jsp?bo_table=story&amp;wr_id=5"
												title="다양한 분위기 연출로 매장을 더욱 빛나게 ~"> <img
												src="https://ebiga.co.kr/home/data/file/story/thumb-1025970348_kYh69z1y_0512c932a0960272fdc16e636854789d9a4399d4_400x300.jpg"
												alt="" class="img_style" />
										</div> </a>
										<div class="text_area">
											<ul>
												<li class="js_tit"><a
													href="https://ebiga.co.kr/home/bbs/board.jsp?bo_table=story&amp;wr_id=5"><i
														class="fa fa-trophy" aria-hidden="true"></i> 다양한 분위기 연출로
														매장을 더욱 빛나게 ~</a>&nbsp;&nbsp;</li>
												<!-- <li class="js_con"><span>전화<span> :  </li>
				<li class="js_con"><span>영업시간<span> :  </li> -->
												<li class="detail_btn"><a
													href="https://ebiga.co.kr/home/bbs/board.jsp?bo_table=story&amp;wr_id=5">자세히보기</a></li>
