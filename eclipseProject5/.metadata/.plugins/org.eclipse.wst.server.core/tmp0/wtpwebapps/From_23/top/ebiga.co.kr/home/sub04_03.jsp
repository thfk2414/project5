...
<body>
	...
	<div id="container">
		...
		<div id="sub" class="sub04_03">

			<div class="sub04_title">
				<i class="fa fa-retweet" aria-hidden="true"></i>
				<h2>
					"이비가 짬뽕만의 <span>특별한 Open Know-How"</span>
				</h2>
				<h3>성공 창업의 지름길</h3>
				<p>
					이비가 짬뽕은 창업주의 적성과 매장 입지를 철저히 분석하여 위험 확률을 최소화 하며,<br>‘신뢰는 곧 성공’
					이라는 파트너쉽을 가지고 창업주 여러분의 성공을 약속합니다.
				</p>
			</div>

			<ul class="list">
				<li><img src="./image/sub04_03_step01.png" alt="step1"> <span>Step01</span>
					개설희망자 문의</li>
				<li><img src="./image/sub04_03_step02.png" alt="step2"> <span>Step02</span>
					사업설명 및 상담</li>
				<li><img src="./image/sub04_03_step03.png" alt="step3"> <span>Step03</span>
					점포개발 및 상권분석</li>
				<li><img src="./image/sub04_03_step04.png" alt="step4"> <span>Step04</span>
					최종협의</li>
				<li><img src="./image/sub04_03_step05.png" alt="step5"> <span>Step05</span>
					가맹계약체결</li>
				<li><img src="./image/sub04_03_step06.png" alt="step6"> <span>Step06</span>
					점포신축 및 실내/외 공사</li>
				<li><img src="./image/sub04_03_step07.png" alt="step7"> <span>Step07</span>
					조리 및 운영 교육실시</li>
				<li><img src="./image/sub04_03_step08.png" alt="step8"> <span>Step08</span>
					식자재 및 개점 준비 마무리</li>
				<li><img src="./image/sub04_03_step09.png" alt="step9"> <span>Step09</span>
					가맹점 개설 및 영업시작</li>
				<li><img src="./image/sub04_03_step10.png" alt="step10">
					<span>Step10</span> 사후관리</li>
			</ul>
