...
// 강원도 : 서울오른쪽상단겹치는부분에서 시작
	...
	var sca_arr = new Array('서울', '경기', '인천', '강원', '충북', '충남', 
			'대전', '세종', '광주', '전북', '전남', '경북', 
			'경남', '대구', '부산', '울산', '제주');
	var sca_state_arr = new Array('seoul', 'gygg', 'incheon', 'gangwon', 'chungbuk', 'chungnam',
			'daejeon','sejong','gwangju','jeonbuk','jeonnam', 'gyeongbuk',
			'gyeongnam', 'daegu', 'busan', 'ulsan', 'jeju');
	var sca_now = "";
	if(sca_arr.indexOf(document.getElementById("sca").value) > -1){		
		sca_now = sca_state_arr[sca_arr.indexOf(document.getElementById("sca").value)];
	}
	...
	for (var state in aus) {
		...
		//	}
			...
			st[0].onclick = function () {				
				switch(state) { 
					case "seoul":
						location.href="/home/bbs/search.jsp="+bo_table+"&sca=서울";
						current = state;
						break;
					case "gygg":
						location.href="/home/bbs/search.jsp="+bo_table+"&sca=경기";
						current = state;
						break;
					case "incheon":
						location.href="/home/bbs/search.jsp="+bo_table+"&sca=인천";
						current = state;
						break;
					case "gangwon":
						location.href="/home/bbs/search.jsp="+bo_table+"&sca=강원";
						break;
					case "chungbuk":
						location.href="/home/bbs/search.jsp="+bo_table+"&sca=충북";
						break;
					case "chungnam":
						location.href="/home/bbs/search.jsp="+bo_table+"&sca=충남";
						break;
					case "daejeon":
						location.href="/home/bbs/search.jsp="+bo_table+"&sca=대전";
						break;
					case "sejong":
						location.href="/home/bbs/search.jsp="+bo_table+"&sca=세종";
						break;
					case "jeonbuk":
						location.href="/home/bbs/search.jsp="+bo_table+"&sca=전북";
						break;
					case "gwangju":
						location.href="/home/bbs/search.jsp="+bo_table+"&sca=광주";
						break;
					case "jeonnam":
						location.href="/home/bbs/search.jsp="+bo_table+"&sca=전남";
						break;
					case "gyeongbuk":
						location.href="/home/bbs/search.jsp="+bo_table+"&sca=경북";
						break;
					case "daegu":
						location.href="/home/bbs/search.jsp="+bo_table+"&sca=대구";
						break;
					case "gyeongnam":
						location.href="/home/bbs/search.jsp="+bo_table+"&sca=경남";
						break;
					case "ulsan":
						location.href="/home/bbs/search.jsp="+bo_table+"&sca=울산";
						break;
					case "busan":
						location.href="/home/bbs/search.jsp="+bo_table+"&sca=부산";
						break;
					case "jeju":
						location.href="/home/bbs/search.jsp="+bo_table+"&sca=제주";
						break;
					default:
						location.href="#";
						break;
